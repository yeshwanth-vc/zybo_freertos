...
typedef volatile unsigned char __metal_io_u8;
typedef volatile unsigned short __metal_io_u16;
typedef volatile unsigned int __metal_io_u32;
#if __riscv_xlen >= 64
typedef volatile unsigned long __metal_io_u64;
#endif
