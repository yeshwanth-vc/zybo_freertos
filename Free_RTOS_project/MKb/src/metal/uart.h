...
struct metal_uart_vtable {
    ...
    int (*getcs)(struct metal_uart *uart, unsigned char *pb, int len);
    int (*getcs_hex)(struct metal_uart *uart, unsigned char *pb, int len);
    int (*getline)(struct metal_uart *uart, unsigned char *pb, int len);
...
__inline__ int metal_uart_getcs(struct metal_uart *uart, unsigned char *pb, int len) {
    return uart->vtable->getcs(uart, pb, len);
}

__inline__ int metal_uart_getcs_hex(struct metal_uart *uart, unsigned char *pb, int len) {
    return uart->vtable->getcs_hex(uart, pb, len);
}

__inline__ int metal_uart_getline(struct metal_uart *uart, unsigned char *pb, int len) {
    return uart->vtable->getline(uart, pb, len);
}
