...
struct metal_rtc_vtable {
    uint32_t (*get_rate)(const struct metal_rtc *const rtc);
    uint32_t (*set_rate)(const struct metal_rtc *const rtc,
                         const uint32_t rate);
    uint32_t (*get_compare)(const struct metal_rtc *const rtc);
    uint32_t (*set_compare)(const struct metal_rtc *const rtc,
                            const uint32_t compare);
    uint32_t (*get_count)(const struct metal_rtc *const rtc);
    uint32_t (*set_count)(const struct metal_rtc *const rtc,
    ...
    int (*clear_interrupt)(const struct metal_rtc *const rtc);
};
 ...
 */
inline uint32_t metal_rtc_get_rate(const struct metal_rtc *const rtc) {
 ...
 */
inline uint32_t metal_rtc_set_rate(const struct metal_rtc *const rtc,
                                   const uint32_t rate) {
 ...
 */
inline uint32_t metal_rtc_get_compare(const struct metal_rtc *const rtc) {
 ...
 */
inline uint32_t metal_rtc_set_compare(const struct metal_rtc *const rtc,
                                      const uint32_t compare) {
 ...
 * @return The count
 */
inline uint32_t metal_rtc_get_count(const struct metal_rtc *const rtc) {
 ...
 */
inline uint32_t metal_rtc_set_count(const struct metal_rtc *const rtc,
                                    const uint32_t count) {
 ...
 */
inline int metal_rtc_clear_interrupt(const struct metal_rtc *const rtc) {
    return rtc->vtable->clear_interrupt(rtc);
}
