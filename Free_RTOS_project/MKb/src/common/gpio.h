...
#include </home/admin1/zybo_FLC/Zybo_Uart/uart/inc/compiler.h>
#include </home/admin1/zybo_FLC/Zybo_Uart/uart/inc/interrupt.h>
...
__inline__ int metal_gpio_get_input_pin(struct metal_gpio *gpio, int pin) {
    ...
    int value = gpio->vtable->input(gpio);
